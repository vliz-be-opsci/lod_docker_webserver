...
- **Linkset Path:** `/linksets/resource-arms-2018.linkset.json`
...
- 🐢 `/rdf/resource-arms-2018.ttl`
- 🐢 `/rdf/resource-arms-2018.jsonld`

### Content Negotiation (RFC 9110)
GET /resource/resource-arms-2018 with Accept: text/turtle returns 303 to /rdf/resource-arms-2018.ttl.
